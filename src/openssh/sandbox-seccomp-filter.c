/*
 * Modified from OpenSSH-6.6p1; contrast with
 * examples/openssh/sandbox-seccomp-policy.c
 */
...
__asm("\n"
      ".globl openssh_policy_gen\n"
      "openssh_policy_gen:\n"
      ".incbin \"openssh-policy.gen\"\n"
      "openssh_policy_gen_end:\n"
      ".globl openssh_policy_gen_size\n"
      "openssh_policy_gen_size:\n"
      ".int openssh_policy_gen_end - openssh_policy_gen\n"
      "\n");

extern char openssh_policy_gen[];
extern int openssh_policy_gen_size;
...
ssh_sandbox_child(struct ssh_sandbox *box)
{
	...
	struct sock_fprog preauth_program_gen = {
		.len = openssh_policy_gen_size / 8,
		.filter = (struct sock_filter *) &openssh_policy_gen[0],
	};
	...
	if (prctl(PR_SET_SECCOMP, SECCOMP_MODE_FILTER, &preauth_program_gen) == -1)
