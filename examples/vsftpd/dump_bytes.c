...
// customize
int tunable_anon_mkdir_write_enable = 1;
int tunable_anon_other_write_enable = 1;
int tunable_async_abor_enable = 1;
int tunable_chmod_enable = 1;
int tunable_chown_uploads = 1;
int tunable_data_connection_timeout = 1;
int tunable_delete_failed_uploads = 1;
int tunable_dual_log_enable = 1;
int tunable_idle_session_timeout = 1;
...
int tunable_seccomp_sandbox = 1;
int tunable_ssl_enable = 1;
int tunable_text_userdb_names = 1;
int tunable_use_sendfile = 1;
int tunable_write_enable = 1;
int tunable_xferlog_enable = 1;
...
{
  int is_anon = 1; // p_sess->is_anonymous;
...
seccomp_sandbox_lockdown()
{
  ...
  unsigned char *bs = (unsigned char *) filters;
...
int main() {
  seccomp_sandbox_init();
  seccomp_sandbox_setup_postlogin(NULL);
  seccomp_sandbox_lockdown();
}
