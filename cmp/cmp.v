...
Definition _n : ident := 32%positive.
...
Definition _hashcmp : ident := 36%positive.
Definition _s2 : ident := 31%positive.
...
Definition f_bcmp := {|
  ...
  fn_params := ((_s1, (tptr tuchar)) :: (_s2, (tptr tuchar)) ::
                (_n, tuint) :: nil);
  fn_vars := nil;
    ...
    (Sloop
      (Ssequence
        ...
        (Sifthenelse (Ebinop One
                       (Ederef
                         (Ebinop Oadd (Etempvar _s1 (tptr tuchar))
                           (Etempvar _i tuint) (tptr tuchar)) tuchar)
                       (Ederef
                         (Ebinop Oadd (Etempvar _s2 (tptr tuchar))
...
Definition f_hashcmp := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_s1, (tptr tuchar)) :: (_s2, (tptr tuchar)) ::
                (_n, tuint) :: nil);
  fn_vars := nil;
  fn_temps := ((_i, tuint) :: (_diff, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _diff (Econst_int (Int.repr 0) tint))
  (Ssequence
    (Ssequence
      (Sset _i (Econst_int (Int.repr 0) tint))
      (Sloop
        (Ssequence
          (Sifthenelse (Ebinop Olt (Etempvar _i tuint) (Etempvar _n tuint)
            ...
            Sbreak)
          (Sset _diff
            (Ebinop Oor (Etempvar _diff tint)
              (Ebinop Oxor
                (Ederef
                  (Ebinop Oadd (Etempvar _s1 (tptr tuchar))
                    (Etempvar _i tuint) (tptr tuchar)) tuchar)
                (Ederef
                  (Ebinop Oadd (Etempvar _s2 (tptr tuchar))
                    (Etempvar _i tuint) (tptr tuchar)) tuchar) tint) tint)))
        (Sset _i
          (Ebinop Oadd (Etempvar _i tuint) (Econst_int (Int.repr 1) tint)
            tuint))))
    (Sreturn (Some (Etempvar _diff tint)))))
|}.
...
((___builtin_fabs,
 ...
 (___builtin_write32_reversed,
   Gfun(External (EF_builtin ___builtin_write32_reversed
     ...
     tvoid cc_default)) :: (_bcmp, Gfun(Internal f_bcmp)) ::
 (_hashcmp, Gfun(Internal f_hashcmp)) :: nil);
prog_main := _main
|}.
